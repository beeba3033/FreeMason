...
namespace Freemason.Advertisements {
    public class Advertisements : MonoBehaviour 
    {
        ...
        public AdvertisementPrefabs FindTarget(AdvertisementPrefabs target) => ( 
            Targets.Find( x => x.gameObject.GetInstanceID() == target.gameObject.GetInstanceID()) 
        ); 
    }
